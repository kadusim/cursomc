...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Celia", "celiacolona@hotmail.com","36022232824", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("979875755", "979876106"));
		
		Endereco e1 = new Endereco(null, "Rua Anhaia", "10", "ap2", "Bom Retiro", "01222000", cli1, c1);
		Endereco e2 = new Endereco(null, "Av Angelica", "193", "", "Higienopolis", "01345000", cli1, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/09/2019 10:32"), cli1, e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, ped1, 6);
		ped1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("11/09/2019 10:32"), null);
